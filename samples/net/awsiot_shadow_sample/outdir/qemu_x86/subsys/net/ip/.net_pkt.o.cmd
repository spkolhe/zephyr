...
deps_subsys/net/ip/net_pkt.o := \
    ...
    $(wildcard include/config/net/debug/net/pkt/externals.h) \
...
subsys/net/ip/net_pkt.o: $(deps_subsys/net/ip/net_pkt.o)
